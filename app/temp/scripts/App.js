...
var introTypewriter = new __WEBPACK_IMPORTED_MODULE_0__modules_Typewriter__["a" /* default */](heroArea,
  ...
  var sectionTitles = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('h2');
  var title = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('h2').text();
  var titlesTypewriter = new __WEBPACK_IMPORTED_MODULE_0__modules_Typewriter__["a" /* default */](sectionTitles, 
  [
    title
  ],false,
  true,
  function() {
                  __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.reveal-content').fadeIn('slow');
                 }
  );
